document.addEventListener("DOMContentLoaded", () => {
    ...
    async function showPageData(title) {
        console.log("showPageData called with title:", title);
        showLoader(true);
        try {
    ...
    function calculateTopWords(text) {
        console.log("calculateTopWords called");
    ...
    function generateWordCloud(wordData) {
        console.log("generateWordCloud called with wordData:", wordData);
